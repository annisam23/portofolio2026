  ...
  return (
    <div className='flex items-center justify-center z-20 pointer-events-none'>
      <div className='relative pointer-events-auto min-[320px]:-mt-40 sm:mt-0'>
        ...
        <p
          ref={roleRef}
          className='absolute left-1/2 min-w-[360px] -top-7 text-white min-[320px]:text-lg sm:text-xl md:text-2xl font-holtwood -translate-x-1/2 z-25'
        >
          QUALITY ASSURANCE
        </p>
        ...
        <h1
          ref={nameRef}
          className='min-[200px]:text-4xl sm:text-5xl font-holtwood font-bold text-white drop-shadow-2xl bg-neutral-900 hover:text-[#ffe066] transition-colors duration-600 px-6 py-3 rounded-lg text-center z-10 will-change-transform'
          style={{
            opacity: 0,
